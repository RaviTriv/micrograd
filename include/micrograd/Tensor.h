...
private:
  ...
  std::shared_ptr<Tensor> add_scalar_metal(double scalar);
  std::shared_ptr<Tensor> sub_scalar_metal(double scalar);
  std::shared_ptr<Tensor> mul_scalar_metal(double scalar);
